        ...
        return `
            <div class="flex flex-col h-full bg-white border-r border-slate-200">
                <div class="h-[45px] flex items-center px-4 border-b border-slate-100 bg-slate-50 justify-between">
                    <span class="font-black text-[11px] text-slate-800 uppercase">${car.id} 상담하기</span>
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-4 bg-[#f1f3f6] hide-scrollbar text-[11px]">
                    <div class="bg-white p-3 rounded-lg border border-slate-200 shadow-sm text-slate-700">
                        <b>${car.모델}</b> 차량 문의를 남겨주세요. 담당자가 확인 후 답변드립니다.
                    </div>
                </div>
                <div class="p-3 border-t bg-white flex gap-2">
                    <input type="text" placeholder="메시지 입력..." class="flex-1 bg-slate-50 border-none outline-none px-3 text-[11px] rounded">
